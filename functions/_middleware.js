...
const RUTAS = {
  ...
  '/blog/camisa-a-medida-lima': {
    ...
    imagen: 'camisa-hero.jpg',
    miga: 'Camisa a medida: el cuello, el puño y por qué el patrón lo decide todo',
    padre: { nombre: 'Blog', ruta: '/blog' },
  },
  '/blog/telas-italianas-en-lima': {
    pagina: 'art-italianas',
    articulo: true,
    ...
    imagen: 'editorial/ed-macro-orillo.jpg',
    miga: 'Qué cambia una tela italiana en un terno',
    padre: { nombre: 'Blog', ruta: '/blog' },
  },
  '/blog/telas-barrington-muestrario-completo': {
    pagina: 'art-barrington',
    articulo: true,
    ...
    imagen: 'editorial/ed-macro-cuadros.jpg',
    miga: 'El muestrario completo de Barrington, tela por tela',
    padre: { nombre: 'Blog', ruta: '/blog' },
  },
  '/blog/sastreria-abierta-domingo-lima': {
    pagina: 'art-domingo',
    articulo: true,
  ...
  '/blog/como-llegar-a-nuestras-tiendas': {
    pagina: 'art-como-llegar',
    articulo: true,
    ...
    imagen: 'hero.jpg',
    miga: 'Cómo llegar a nuestras seis tiendas de Lima',
    padre: { nombre: 'Blog', ruta: '/blog' },
  },
  '/blog/terno-a-medida-o-de-tienda': {
    pagina: 'art-medida-tienda',
    articulo: true,
    ...
    miga: 'Terno a medida o de tienda: en qué se nota la diferencia',
    padre: { nombre: 'Blog', ruta: '/blog' },
  },
  '/privacidad': {
    pagina: 'privacidad',
